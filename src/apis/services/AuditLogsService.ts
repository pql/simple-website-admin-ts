...
import type { Volo_Abp_AuditLogging_AuditLogDto_Volo_Abp_AuditLogging_Application_Contracts_Version_8_3_0_0_Culture_neutral_PublicKeyToken_null_ } from '../models/Volo_Abp_AuditLogging_AuditLogDto_Volo_Abp_AuditLogging_Application_Contracts_Version_8_3_0_0_Culture_neutral_PublicKeyToken_null_';
import type { Volo_Abp_AuditLogging_EntityChangeDto } from '../models/Volo_Abp_AuditLogging_EntityChangeDto';
import type { Volo_Abp_AuditLogging_EntityChangeDto_Volo_Abp_AuditLogging_Application_Contracts_Version_8_3_0_0_Culture_neutral_PublicKeyToken_null_ } from '../models/Volo_Abp_AuditLogging_EntityChangeDto_Volo_Abp_AuditLogging_Application_Contracts_Version_8_3_0_0_Culture_neutral_PublicKeyToken_null_';
...
export class AuditLogsService {
    /**
     * @returns Volo_Abp_Application_Dtos_PagedResultDto_1<Volo_Abp_AuditLogging_AuditLogDto_Volo_Abp_AuditLogging_Application_Contracts_Version_8_3_0_0_Culture_neutral_PublicKeyToken_null_> Success
     * @throws ApiError
     */
    public static getApiAuditLoggingAuditLogs({
        startTime,
        endTime,
        url,
        clientId,
     ...
     * @throws ApiError
     */
    public static getApiAuditLoggingAuditLogs1({
        id,
    }: {
        id: string,
     ...
     * @throws ApiError
     */
    public static getApiAuditLoggingAuditLogsStatisticsErrorRate({
        startDate,
        endDate,
    }: {
        startDate?: string,
     ...
     * @throws ApiError
     */
    public static getApiAuditLoggingAuditLogsStatisticsAverageExecutionDurationPerDay({
        startDate,
        endDate,
    }: {
        startDate?: string,
    ...
    /**
     * @returns Volo_Abp_Application_Dtos_PagedResultDto_1<Volo_Abp_AuditLogging_EntityChangeDto_Volo_Abp_AuditLogging_Application_Contracts_Version_8_3_0_0_Culture_neutral_PublicKeyToken_null_> Success
     * @throws ApiError
     */
    public static getApiAuditLoggingAuditLogsEntityChanges({
        auditLogId,
        entityChangeType,
        entityId,
        entityTypeFullName,
     ...
     * @throws ApiError
     */
    public static getApiAuditLoggingAuditLogsEntityChangesWithUsername({
        entityId,
        entityTypeFullName,
    }: {
        entityId?: string,
     ...
     * @throws ApiError
     */
    public static getApiAuditLoggingAuditLogsEntityChangeWithUsername({
        entityChangeId,
    }: {
     ...
     * @throws ApiError
     */
    public static getApiAuditLoggingAuditLogsEntityChanges1({
        entityChangeId,
    }: {
        entityChangeId: string,
