...
export class RoleService {
     ...
     * @throws ApiError
     */
    public static putApiIdentityRolesClaims({
        id,
        requestBody,
    }: {
        id: string,
     ...
     * @throws ApiError
     */
    public static getApiIdentityRolesClaims({
        id,
    }: {
        id: string,
     ...
     * @throws ApiError
     */
    public static putApiIdentityRolesMoveAllUsers({
        id,
        roleId,
    }: {
        id: string,
     ...
     * @throws ApiError
     */
    public static getApiIdentityRolesAllClaimTypes(): CancelablePromise<Array<Volo_Abp_Identity_ClaimTypeDto>> {
        return __request(OpenAPI, {
            method: 'GET',
