...
export class ConversationService {
     ...
     * @throws ApiError
     */
    public static postApiChatConversationSendMessage({
        requestBody,
    }: {
     ...
     * @throws ApiError
     */
    public static deleteApiChatConversationDeleteMessage({
        targetUserId,
        messageId,
    }: {
        targetUserId?: string,
     ...
     * @throws ApiError
     */
    public static getApiChatConversationConversation({
        targetUserId,
        skipCount,
        maxResultCount,
    }: {
     ...
     * @throws ApiError
     */
    public static postApiChatConversationMarkConversationAsRead({
        requestBody,
    }: {
     ...
     * @throws ApiError
     */
    public static deleteApiChatConversationDeleteConversation({
        targetUserId,
    }: {
        targetUserId?: string,
    }): CancelablePromise<any> {
