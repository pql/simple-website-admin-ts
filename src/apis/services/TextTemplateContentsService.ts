...
export class TextTemplateContentsService {
     ...
     * @throws ApiError
     */
    public static getApiTextTemplateManagementTemplateContents({
        templateName,
        cultureName,
    }: {
        templateName: string,
     ...
     * @throws ApiError
     */
    public static putApiTextTemplateManagementTemplateContents({
        requestBody,
    }: {
     ...
     * @throws ApiError
     */
    public static putApiTextTemplateManagementTemplateContentsRestoreToDefault({
        requestBody,
    }: {
