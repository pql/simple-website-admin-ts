...
export class OrganizationUnitService {
     ...
     * @throws ApiError
     */
    public static putApiIdentityOrganizationUnitsRoles({
        id,
        requestBody,
    }: {
        id: string,
    ...
    /**
     * @returns Volo_Abp_Application_Dtos_PagedResultDto_1<Volo_Abp_Identity_IdentityRoleDto_Volo_Abp_Identity_Pro_Application_Contracts_Version_8_3_0_0_Culture_neutral_PublicKeyToken_null_> Success
     * @throws ApiError
     */
    public static getApiIdentityOrganizationUnitsRoles({
        id,
        sorting,
        skipCount,
        maxResultCount,
     ...
     * @throws ApiError
     */
    public static putApiIdentityOrganizationUnitsMembers({
        id,
        requestBody,
    }: {
        id: string,
     ...
     * @throws ApiError
     */
    public static getApiIdentityOrganizationUnitsMembers({
        id,
        filter,
        roleId,
        organizationUnitId,
     ...
     * @throws ApiError
     */
    public static postApiIdentityOrganizationUnits({
        requestBody,
    }: {
     ...
     * @throws ApiError
     */
    public static deleteApiIdentityOrganizationUnits({
        id,
    }: {
        id?: string,
    }): CancelablePromise<any> {
    ...
    /**
     * @returns Volo_Abp_Application_Dtos_PagedResultDto_1<Volo_Abp_Identity_OrganizationUnitWithDetailsDto_Volo_Abp_Identity_Pro_Application_Contracts_Version_8_3_0_0_Culture_neutral_PublicKeyToken_null_> Success
     * @throws ApiError
     */
    public static getApiIdentityOrganizationUnits({
        filter,
        sorting,
        skipCount,
        maxResultCount,
     ...
     * @throws ApiError
     */
    public static getApiIdentityOrganizationUnits1({
        id,
    }: {
        id: string,
    }): CancelablePromise<Volo_Abp_Identity_OrganizationUnitWithDetailsDto> {
     ...
     * @throws ApiError
     */
    public static putApiIdentityOrganizationUnits({
        id,
        requestBody,
    }: {
        id: string,
     ...
     * @throws ApiError
     */
    public static getApiIdentityOrganizationUnitsAll(): CancelablePromise<Volo_Abp_Application_Dtos_ListResultDto_1> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static putApiIdentityOrganizationUnitsMove({
        id,
        requestBody,
    }: {
        id: string,
     ...
     * @throws ApiError
     */
    public static getApiIdentityOrganizationUnitsAvailableUsers({
        filter,
        id,
        sorting,
        skipCount,
     ...
     * @throws ApiError
     */
    public static getApiIdentityOrganizationUnitsAvailableRoles({
        filter,
        id,
        sorting,
        skipCount,
     ...
     * @throws ApiError
     */
    public static putApiIdentityOrganizationUnitsMoveAllUsers({
        id,
        organizationId,
    }: {
        id: string,
     ...
     * @throws ApiError
     */
    public static deleteApiIdentityOrganizationUnitsMembers({
        id,
        memberId,
    }: {
        id: string,
     ...
     * @throws ApiError
     */
    public static deleteApiIdentityOrganizationUnitsRoles({
        id,
        roleId,
    }: {
        id: string,
