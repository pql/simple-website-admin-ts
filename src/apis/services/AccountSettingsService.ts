...
export class AccountSettingsService {
     ...
     * @throws ApiError
     */
    public static getApiAccountAdminSettings(): CancelablePromise<Volo_Abp_Account_AccountSettingsDto> {
     ...
     * @throws ApiError
     */
    public static putApiAccountAdminSettings({
        requestBody,
    }: {
     ...
     * @throws ApiError
     */
    public static getApiAccountAdminSettingsTwoFactor(): CancelablePromise<Volo_Abp_Account_AccountTwoFactorSettingsDto> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static putApiAccountAdminSettingsTwoFactor({
        requestBody,
    }: {
     ...
     * @throws ApiError
     */
    public static getApiAccountAdminSettingsRecaptcha(): CancelablePromise<Volo_Abp_Account_AccountRecaptchaSettingsDto> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static putApiAccountAdminSettingsRecaptcha({
        requestBody,
    }: {
     ...
     * @throws ApiError
     */
    public static getApiAccountAdminSettingsExternalProvider(): CancelablePromise<Volo_Abp_Account_AccountExternalProviderSettingsDto> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static putApiAccountAdminSettingsExternalProvider({
        requestBody,
    }: {
