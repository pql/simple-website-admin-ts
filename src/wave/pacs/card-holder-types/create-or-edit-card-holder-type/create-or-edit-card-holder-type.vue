    ...
    <div class="modal-body modal-body-extra">
      ...
      >
        <a-row :gutter="24">
          <a-col :span="24">
            <!-- Card Format -->
            <a-form-item :label="l('Unified.texts.CardHolderType')" name="cardHolderTypeName">
              <a-input
                name="cardHolderTypeName"
                v-model:value="form.cardHolderTypeName"
                :autocomplete="'off'"
              />
            </a-form-item>
          </a-col>
...
<script lang="ts">
  ...
  import CreateoOrEditCardHolder from './create-or-edit-card-holder-type';
