    ...
    <div class="modal-body modal-body-extra">
      ...
      >
        <a-row :gutter="24">
          <a-col :span="24">
            <!-- Card Format -->
            <a-form-item :label="l('Unified.texts.CardFormat')" name="cardFormat">
              <a-input
                name="cardFormat"
                v-model:value="form.cardFormat"
                :autocomplete="'off'"
              />
            </a-form-item>
          </a-col>
...
<script lang="ts">
  ...
  import CreateoOrEditCardFormat from './create-or-edit-card-format';

  export default defineComponent({
    name: 'CreateoOrEditCardFormat',
    mixins: [CreateoOrEditCardFormat],
  });
</script>
