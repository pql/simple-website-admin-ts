...
<script lang="ts">
  ...
  import { InterfaceServiceService, FireBytes_Unified_Shared_NdoDto as NdoDto } from '/@/apis';
  export default defineComponent({
    name: 'interface-service-select',
    props: {
      placeHolder: {
        type: String,
      },
    ...
    methods: {
      ...
      searchList(val) {
        InterfaceServiceService.getApiAppInterfaceServiceNdoList({
          filter: val,
        }).then((result) => {
