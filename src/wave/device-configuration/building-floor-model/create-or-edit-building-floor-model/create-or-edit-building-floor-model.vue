    ...
    <div class="modal-body">
      ...
      >
        <a-row :gutter="16">
          ...
          <a-col :span="24">
            <!-- ModelName -->
            <a-form-item :label="l('Unified.texts.ModelName')" name="modelName">
              <a-input
                name="modelName"
...
<script lang="ts">
  ...
  import CreateOrEditBuildingFloorModel from './create-or-edit-building-floor-model';

  export default defineComponent({
    name: 'CreateOrEditBuildingFloorModel',
    mixins: [CreateOrEditBuildingFloorModel],
  });
</script>
