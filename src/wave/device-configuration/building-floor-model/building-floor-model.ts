...
import CreateOrEditBuildingFloorModel from './create-or-edit-building-floor-model/create-or-edit-building-floor-model.vue';
  ...
  methods: {
    ...
    createOrEdit(item?) {
      const param = {
        ...
        _titleName:
          item?.id == null
            ? 'Unified.texts.CreateNewBuildingFloorModel'
            : 'Unified.texts.EditBuildingFloorModel',
      };
      this.modalHelper
        .create(CreateOrEditBuildingFloorModel, { ...param }, { width: '500px' })
        .subscribe((res) => {
          if (res) {
    ...
    bulkEdit() {
      ...
      const param = {
        ...
        _types: '',
        _titleName: 'Unified.texts.EditBuildingFloorModel',
      };
      this.modalHelper
        .create(CreateOrEditBuildingFloorModel, { ...param }, { size: 'small' })
        .subscribe((res) => {
          if (res) {
            (this.$refs.table as any).reloadGoFirstPage();
          }
