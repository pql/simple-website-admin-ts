    ...
    <div class="modal-body modal-body-extra">
      ...
      >
        <a-row :gutter="16">
          <a-col :span="24">
            <!-- BrandName -->
            <a-form-item :label="l('Unified.texts.BrandName')" name="brandName">
              <a-input
                name="brandName"
...
<script lang="ts">
  ...
  import CreateoOrEditInterfaceBrand from './create-or-edit-interface-brand';

  export default defineComponent({
    name: 'CreateoOrEditInterfaceBrand',
    mixins: [CreateoOrEditInterfaceBrand],
  });
</script>
