<template>
  <Input
    :style="{ width }"
    :placeholder="t('Unified.texts.component:icon:placeholder')"
    :class="prefixCls"
      ...
      >
        <template #title>
          <div class="flex justify-between">
            <Input
              :placeholder="t('Unified.texts.component:icon:search')"
...
<script lang="ts" setup>
  ...
  function handleClick(icon: string) {
    ...
    if (props.copy) {
      copyText(icon, t('Unified.texts.component:icon:copy'));
    }
  }
