<template>
  <Tooltip placement="top">
    <template #title>
      <span>{{ t('Unified.texts.component:table:settingColumn') }}</span>
    </template>
    <Popover
    ...
    >
      <template #title>
        <div :class="`${prefixCls}__popover-title`">
          ...
          >
            {{ t('Unified.texts.component:table:settingColumnShow') }}
          </Checkbox>

          <Checkbox v-model:checked="isIndexColumnShow" @change="onIndexColumnShowChange">
            {{ t('Unified.texts.component:table:settingIndexColumnShow') }}
          </Checkbox>
          ...
          >
            {{ t('Unified.texts.component:table:settingSelectColumnShow') }}
          </Checkbox>
          ...
          <Checkbox.Group v-model:value="columnCheckedOptions" ref="columnOptionsRef">
            <template v-for="opt in columnOptions" :key="opt.value">
              <div :class="`${prefixCls}__check-item`" :data-no="opt.value">
                ...
                >
                  <template #title>
                    {{ t('Unified.texts.component:table:settingFixedLeft') }}
                  </template>
                  <Icon
                ...
                >
                  <template #title>
                    {{ t('Unified.texts.component:table:settingFixedRight') }}
                  </template>
                  <Icon
                    icon="line-md:arrow-align-left"
                    :class="[
...
<script lang="ts" setup>
  ...
  import { TableSettingStore } from '@/store/modules/tableSetting';

  const tableSettingStore = TableSettingStore.useStore();
