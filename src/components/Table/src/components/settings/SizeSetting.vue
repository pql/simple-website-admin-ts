<template>
  <Tooltip placement="top">
    <template #title>
      <span>{{ t('Unified.texts.component:table:settingDens') }}</span>
    </template>
      ...
      <template #overlay>
        <Menu @click="handleTitleClick" selectable v-model:selectedKeys="selectedKeysRef">
          <Menu.Item key="default">
            <span>{{ t('Unified.texts.Default') }}</span>
          </Menu.Item>
          <Menu.Item key="middle">
            <span>{{ t('Unified.texts.component:table:settingDensMiddle') }}</span>
          </Menu.Item>
          <Menu.Item key="small">
            <span>{{ t('Unified.texts.component:table:settingDensSmall') }}</span>
          </Menu.Item>
        </Menu>
      </template>
    </Dropdown>
